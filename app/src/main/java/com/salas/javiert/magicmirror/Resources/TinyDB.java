...
public class TinyDB {
    ...
    /**
     * Saves 'theBitmap' into folder 'theFolder' with the occur_name 'theImageName'
     *
     * @param theFolder    the folder path dir you want to save it to e.g "DropBox/WorkImages"
     * @param theImageName the occur_name you want to assign to the image file e.g "MeAtLunch.png"
    ...
    /**
     * Creates the path for the image with occur_name 'imageName' in DEFAULT_APP.. directory
     *
     * @param imageName occur_name of the image
