...
public class WelcomeScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_welcome_main);
        ...
        layouts = new int[]{
                R.layout.layout_welcome_pages1,
                R.layout.layout_welcome_pages2,
                R.layout.layout_welcome_pages3,
                R.layout.layout_welcome_pages4};
        ...
        // If the user wants to skip through the slider
